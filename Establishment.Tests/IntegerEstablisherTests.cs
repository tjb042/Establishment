...
namespace Establishment.Tests {
    ...
    public class IntegerEstablisherTests {
        ...
        public void Int_IsDefault() {
            var establisher = Establish.For(default(int));
        ...
        public void Int_IsEqualTo() {
            var establisher = Establish.For((int)10);
        ...
        public void Int_IsMaxValue() {
            var establisher = Establish.For(int.MaxValue);
        ...
        public void Int_IsMinValue() {
            var establisher = Establish.For(int.MinValue);
        ...
        public void Int_IsZero() {
            var establisher = Establish.For((int)0);
