...
namespace Establishment.Tests {
    ...
    public class LongEstablisherTests {
        ...
        public void Long_IsDefault() {
            var establisher = Establish.For(default(long));
        ...
        public void Long_IsEqualTo() {
            var establisher = Establish.For((long)10);
        ...
        public void Long_IsMaxValue() {
            var establisher = Establish.For(long.MaxValue);
        ...
        public void Long_IsMinValue() {
            var establisher = Establish.For(long.MinValue);
        ...
        public void Long_IsZero() {
            var establisher = Establish.For((long)0);
