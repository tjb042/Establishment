...
namespace Establishment.Tests {
    ...
    public class ShortEstablisherTests {
        ...
        public void Short_IsDefault() {
            var establisher = Establish.For(default(short));
        ...
        public void Short_IsEqualTo() {
            var establisher = Establish.For((short)10);
        ...
        public void Short_IsMaxValue() {
            var establisher = Establish.For(short.MaxValue);
        ...
        public void Short_IsMinValue() {
            var establisher = Establish.For(short.MinValue);
        ...
        public void Short_IsZero() {
            var establisher = Establish.For((short)0);
