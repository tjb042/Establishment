...
namespace Establishment.Tests {
    ...
    public class ByteEstablisherTests {
        ...
        public void Byte_IsEqualTo() {
            var establisher = Establish.For((byte)10);
        ...
        public void Byte_IsMaxValue() {
            var establisher = Establish.For(byte.MaxValue);
        ...
        public void Byte_IsMinValue() {
            var establisher = Establish.For(byte.MinValue);
        ...
        public void Byte_IsZero() {
            var establisher = Establish.For((byte)0);
